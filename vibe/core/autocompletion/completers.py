...
class CommandCompleter(Completer):
    def __init__(self, commands: list[tuple[str, str]]) -> None:
        ...
        self._aliases: list[str] = sorted(aliases_with_descriptions.keys())
...
class PathCompleter(Completer):
    ...
    def _collect_matches(self, text: str, cursor_pos: int) -> list[str]:
        ...
        try:
            # Use current working directory as root for path completion
            # This is the expected behavior for CLI path completion
