...
class Agent:
    ...
    def queue_message(self, message: str) -> None:
        """Add a message to the queue for processing when the agent is available."""
    ...
    async def process_next_queued_message(self) -> AsyncGenerator[BaseEvent]:
        ...
        try:
            ...
            self.messages.append(LLMMessage(role=Role.user, content=message))
            self.stats.steps += 1
